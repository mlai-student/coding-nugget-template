...
%%% Lamarr colors
\definecolor{lmrrblu}{HTML}{A2A9F5}
\definecolor{lmrrred}{HTML}{F9748C}
\definecolor{lmrryel}{HTML}{FFCB00}
\definecolor{lmrrtrq}{HTML}{9AD1D2}
\definecolor{lmrrprime1}{HTML}{0C122B}
\definecolor{lmrrprime2}{HTML}{FFFFFF}
...
\renewcommand{\algorithmiccomment}[1]{{\color{lmrrtrq}// #1}}
...
\lstdefinestyle{pythonstyle}{%
  language=Python,
  tabsize=4,
  backgroundcolor=\color{lmrrprime1!10},
  basicstyle=\ttfamily\scriptsize,
  stringstyle=\color{lmrrred},
  keywordstyle=\color{lmrrblu},
  commentstyle=\itshape\color{lmrrtrq},
  identifierstyle=,
  emphstyle=\color{lmrrblu},
  frame=lines,	
...
\newcommand{\keyword}[1]{\emph{\texttt{\color{lmrrblu}#1}}}
